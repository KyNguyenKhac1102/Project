...
namespace project.Migrations
{
    ...
    [Migration("20211226183747_IntiCreate12")]
    partial class IntiCreate12
    {
            ...
            modelBuilder.Entity("Project.Models.StudentInfo", b =>
                {
                    ...
                    b.Property<string>("MaDoiTuongId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("MaKhuVucId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("MaDoiTuongId")
                        .IsUnique()
                        .HasFilter("[MaDoiTuongId] IS NOT NULL");

                    b.HasIndex("MaKhuVucId")
                        .IsUnique()
                        .HasFilter("[MaKhuVucId] IS NOT NULL");
            ...
            modelBuilder.Entity("Project.Models.StudentInfo", b =>
                {
                    b.HasOne("Project.Models.DoiTuong", "DoiTuong")
                        .WithOne("StudentInfo")
                        .HasForeignKey("Project.Models.StudentInfo", "MaDoiTuongId");

                    b.HasOne("Project.Models.KhuVuc", "KhuVuc")
                        .WithOne("StudentInfo")
                        .HasForeignKey("Project.Models.StudentInfo", "MaKhuVucId");
